...
-- AddForeignKey
ALTER TABLE "Question" ADD CONSTRAINT "Question_talkSessionId_fkey" FOREIGN KEY ("talkSessionId") REFERENCES "TalkSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
